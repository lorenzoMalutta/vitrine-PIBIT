                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Dashboard Deletar Patentes
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($midia as $midias)
                                                    <form
                                                        action="/dashboard-patentes-deletar/{{ $item->id }}-{{ $midias->idPatente }}"
                                                        method="post">

                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-danger waves-effect waves-float waves-light">Deletar</button>
                                                    </form>
